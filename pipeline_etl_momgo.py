"""
TFM DATA ENGINEERING - PIPELINE ETL UNIFICADO CON TRANSFORMACIONES AVANZADAS
Pipeline completo desde MongoDB con limpieza básica y transformaciones avanzadas integradas
"""
